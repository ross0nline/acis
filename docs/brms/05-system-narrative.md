...
The database currently holds 64 real federal regulatory events, 8 client attestation records, 6 vendor assessments, and 7 incidents with AI-generated NIST playbooks.
